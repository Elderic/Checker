...
public class Dessiner extends JPanel {
	...
	/*private ArrayList<Point> alGreen=new ArrayList<Point>();
	private ArrayList<Point> alWhite=new ArrayList<Point>();*/
	@Override
	public void paintComponent(Graphics g) {
		...
		for(i=0;i<alBlue.size();i++) {
			...
			g.fillOval((int)alGreen.get(i).getX(), (int)alGreen.get(i).getY(), IDEAL_WIDTH, IDEAL_HEIGHT);
			g.setColor(Color.white);
			g.fillOval((int)alWhite.get(i).getX(), (int)alWhite.get(i).getY(), IDEAL_WIDTH, IDEAL_HEIGHT);*/
		}	
	}
	...
	/*public void addGreenArrayList(Point point) {
		alGreen.add(point);
	}
	public void addWhiteArrayList(Point point) {
		alWhite.add(point);
	}*/
}
